...
Ext.Loader.addClassPathMappings({
  ...
  "MyShoppingCartApp": "../../app",
  "MyShoppingCartApp.controller.shoppingCartHelperClass": "../../app/shoppingCartHelperClass/shoppingCartHelperClass.js",
  "MyShoppingCartApp.controller.wishlistController": "../../app/controller/wishListController.js"
});
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "MyShoppingCartApp.controller.cartController": [],
  "MyShoppingCartApp.controller.categoriesContainerController": [],
  "MyShoppingCartApp.controller.productDetailsController": [],
  "MyShoppingCartApp.controller.productsByCatController": [],
  "MyShoppingCartApp.controller.shoppingCartHelperClass": [
    "shoppingCartHelper"
  ],
  "MyShoppingCartApp.controller.shoppingCartNavigationController": [],
  "MyShoppingCartApp.controller.wishlistController": [],
  "MyShoppingCartApp.model.categoryModel": [],
  "MyShoppingCartApp.model.productModel": [],
  "MyShoppingCartApp.store.categoryStore": [],
  "MyShoppingCartApp.store.productsStore": [],
  "MyShoppingCartApp.view.cartContainer": [],
  "MyShoppingCartApp.view.categoriesContainer": [],
  "MyShoppingCartApp.view.productDetailContainer": [],
  "MyShoppingCartApp.view.productsByCatView": [],
  "MyShoppingCartApp.view.shoppingCartNavigationView": [],
  "MyShoppingCartApp.view.wishListView": []
});
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "MyShoppingCartApp.view.productDetailContainer": [
    "widget.productDetailContainer"
  ],
  "MyShoppingCartApp.view.productsByCatView": [
    "widget.productsByCatView"
  ],
  "MyShoppingCartApp.view.shoppingCartNavigationView": [
    "widget.shoppingCartNavigationView"
  ],
  "MyShoppingCartApp.view.wishListView": [
    "widget.wishListView"
  ]
